...
Public Class ClientMasterForm
    ...
    Private clientInfo As Client = New Client()
    ...
    ''' <param name="e"></param>
    Private Sub ClientMasterForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub dgvClient_CellEnter(sender As Object, e As DataGridViewCellEventArgs) Handles dgvClient.CellEnter
    ...
    Private Sub mitmDelete_Click(sender As Object, e As EventArgs) Handles mitmDelete.Click
        ...
        If Clients.delete(selectId) Then
    ...
    ''' <param name="sender"></param>
    ''' <param name="e"></param>
    Private Sub ClientMasterForm_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
    ...
    ''' 得意先リストの表示
    ''' </summary>
    Private Sub setDgvClient()

        '部署リスト
        dgvClient.DataSource = Clients.selectAll()
